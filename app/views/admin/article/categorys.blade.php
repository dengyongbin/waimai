...
<div class="row">
                ...
                <div class="widget-body no-padding">
                    ...
                    <div class="alert alert-info no-margin fade in">
                        <button type="submit" class="btn btn-primary"
                                onclick="location='{{{ URL::to('/admin/article/category/add') }}}';">
                            添加
                        </button>
                        <button type="submit" class="btn btn-primary"
                                onclick="deleteCatg()">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="editCatg()">
                            修改
                        </button>
                    </div>
                    <div class="table-responsive">
                        ...
                        <div class="dt-toolbar-footer" style="text-align: right;">{{$categorys->links();}}</div>
                    </div>
                </div>
                <!-- end widget content -->
    ...
    <script type="text/javascript">
        function deleteCatg() {
            $(":radio").each(function () {
                if (this.checked) {
                    location = '/admin/article/category/delete/' + $(this).next().val();
                }
            });
        }
        function editCatg() {
            $(":radio").each(function () {
                if (this.checked) {
                    location = '/admin/article/category/' + $(this).next().val();
                }
            });
        }
    </script>
